...
export const SURAH_LIST: SurahMetadata[] = [
  ...
  { number: 3, name: "آل عمران", englishName: "Ali 'Imran", englishNameTranslation: "The Family of Imraan", numberOfAyahs: 200, revelationType: "Medinan" },
  ...
  { number: 10, name: "يونس", englishName: "Yunus", englishNameTranslation: "Yonas", numberOfAyahs: 109, revelationType: "Meccan" },
  ...
  { number: 16, name: "النحل", englishName: "An-Nahl", englishNameTranslation: "The Honey Bees", numberOfAyahs: 128, revelationType: "Meccan" },
  ...
  { number: 20, name: "طه", englishName: "Ta-Ha", englishNameTranslation: "Taha", numberOfAyahs: 135, revelationType: "Meccan" },
  ...
  { number: 36, name: "يس", englishName: "Ya-Sin", englishNameTranslation: "Yaseen", numberOfAyahs: 83, revelationType: "Meccan" },
  ...
  { number: 46, name: "الأحقاف", englishName: "Al-Ahqaf", englishNameTranslation: "The Curved Sand-dunes", numberOfAyahs: 35, revelationType: "Meccan" },
  ...
  { number: 70, name: "المعارج", englishName: "Al-Ma'arij", englishNameTranslation: "The Elevating Passages", numberOfAyahs: 44, revelationType: "Meccan" },
  ...
  { number: 82, name: "الإنفطار", englishName: "Al-Infitar", englishNameTranslation: "The Cleaving Asunder", numberOfAyahs: 19, revelationType: "Meccan" },
  ...
  { number: 85, name: "البروج", englishName: "Al-Buruj", englishNameTranslation: "The Big Stars", numberOfAyahs: 22, revelationType: "Meccan" },
  ...
  { number: 108, name: "الكوثر", englishName: "Al-Kawthar", englishNameTranslation: "The Abundant Good", numberOfAyahs: 3, revelationType: "Meccan" },
